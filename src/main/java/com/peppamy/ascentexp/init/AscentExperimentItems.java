...
public class AscentExperimentItems {
    ...
    public static final Item SAPPHIRE_SWORD = register(
        "sapphire_sword",
        new SwordItem(
            AscentExperiment.SapphireMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                SwordItem.createAttributeModifiers(AscentExperiment.SapphireMaterial.INSTANCE, 3, -2.4F)
            )
        ));
    public static final Item SAPPHIRE_PICKAXE = register(
        ...
        new PickaxeItem(
            AscentExperiment.SapphireMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                PickaxeItem.createAttributeModifiers(AscentExperiment.SapphireMaterial.INSTANCE, 1.0F, -2.8F)
            )
        ));
    public static final Item SAPPHIRE_AXE = register(
        ...
        new AxeItem(
            AscentExperiment.SapphireMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                AxeItem.createAttributeModifiers(AscentExperiment.SapphireMaterial.INSTANCE, 5.0F, -3.0F)
            )
        ));
    public static final Item SAPPHIRE_SHOVEL = register(
        ...
        new ShovelItem(
            AscentExperiment.SapphireMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                ShovelItem.createAttributeModifiers(AscentExperiment.SapphireMaterial.INSTANCE, 1.5F, -3.0F)
            )
        ));
    public static final Item SAPPHIRE_HOE = register(
        ...
        new HoeItem(
            AscentExperiment.SapphireMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                HoeItem.createAttributeModifiers(AscentExperiment.SapphireMaterial.INSTANCE, -3.0F, 0.0F)
            )
        ));
    ...
    public static final Item BLOOD_RUTILE_SWORD = register(
        "blood_rutile_sword",
        new SwordItem(AscentExperiment.BloodRutileMaterial.INSTANCE,
                      new Item.Settings().attributeModifiers(
                          SwordItem.createAttributeModifiers(AscentExperiment.BloodRutileMaterial.INSTANCE, 3, -2.4F)
                      )
        ));
    public static final Item BLOOD_RUTILE_PICKAXE = register(
        "blood_rutile_pickaxe",
        new PickaxeItem(
            AscentExperiment.BloodRutileMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                PickaxeItem.createAttributeModifiers(AscentExperiment.BloodRutileMaterial.INSTANCE, 1.0F, -2.8F)
            )
        ));
    public static final Item BLOOD_RUTILE_AXE = register(
        "blood_rutile_axe",
        new AxeItem(
            AscentExperiment.BloodRutileMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                AxeItem.createAttributeModifiers(AscentExperiment.BloodRutileMaterial.INSTANCE, 5.0F, -3.0F)
            )
        ));
    public static final Item BLOOD_RUTILE_SHOVEL = register(
        "blood_rutile_shovel",
        new ShovelItem(
            AscentExperiment.BloodRutileMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                ShovelItem.createAttributeModifiers(AscentExperiment.BloodRutileMaterial.INSTANCE, 1.5F, -3.0F)
            )
        ));
    public static final Item BLOOD_RUTILE_HOE = register(
        "blood_rutile_hoe",
        new HoeItem(
            AscentExperiment.BloodRutileMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                HoeItem.createAttributeModifiers(AscentExperiment.BloodRutileMaterial.INSTANCE, -3.0F, 0.0F)
            )
        ));
    public static final Item BLOOD_RUTILE_HELMET = register(
        ...
        new ArmorItem(
            ...
            new Item.Settings().maxDamage(198)
                               .attributeModifiers(bloodRutileArmorAttributes(ArmorItem.Type.HELMET, 1F))
        ));
    public static final Item BLOOD_RUTILE_CHESTPLATE = register(
        ...
        new ArmorItem(ArmorMaterials.BLOOD_RUTILE,
                      ...
                      new Item.Settings().maxDamage(288)
                                         .attributeModifiers(bloodRutileArmorAttributes(ArmorItem.Type.CHESTPLATE, 2F))
        ));
    public static final Item BLOOD_RUTILE_LEGGINGS = register(
        ...
        new ArmorItem(
            ...
            new Item.Settings().maxDamage(270)
                               .attributeModifiers(bloodRutileArmorAttributes(ArmorItem.Type.LEGGINGS, 2F))
        ));
    public static final Item BLOOD_RUTILE_BOOTS = register(
        ...
        new ArmorItem(
            ...
            new Item.Settings().maxDamage(234)
                               .attributeModifiers(bloodRutileArmorAttributes(ArmorItem.Type.BOOTS, 1F))
        ));
    ...
    public static final Item CHARTIUM_SWORD = register(
        "chartium_sword",
        new SwordItem(
            AscentExperiment.ChartiumMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                SwordItem.createAttributeModifiers(AscentExperiment.ChartiumMaterial.INSTANCE, 3, -2.4F)
            )
        ));
    public static final Item CHARTIUM_PICKAXE = register(
        "chartium_pickaxe",
        new PickaxeItem(
            AscentExperiment.ChartiumMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                PickaxeItem.createAttributeModifiers(AscentExperiment.ChartiumMaterial.INSTANCE, 1.0F, -2.8F)
            )
        ));
    public static final Item CHARTIUM_AXE = register(
        "chartium_axe",
        new AxeItem(
            AscentExperiment.ChartiumMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                AxeItem.createAttributeModifiers(AscentExperiment.ChartiumMaterial.INSTANCE, 5.0F, -3.0F)
            )
        ));
    public static final Item CHARTIUM_SHOVEL = register(
        "chartium_shovel",
        new ShovelItem(AscentExperiment.ChartiumMaterial.INSTANCE,
                       new Item.Settings().attributeModifiers(
                           ShovelItem.createAttributeModifiers(
                               AscentExperiment.ChartiumMaterial.INSTANCE,
                               1.5F, -3.0F))));
    public static final Item CHARTIUM_HOE = register(
        "chartium_hoe",
        new HoeItem(
            AscentExperiment.ChartiumMaterial.INSTANCE,
            new Item.Settings().attributeModifiers(
                HoeItem.createAttributeModifiers(AscentExperiment.ChartiumMaterial.INSTANCE, -3.0F, 0.0F)
            )
        ));
    ...
    public static final Item AEREMONE_BULB = register(
        "aeremone_bulb",
        new AliasedBlockItem(AscentExperimentBlocks.AEREMONE,
                             new Item.Settings().food(AscentExperimentItems.AERO_FOOD))
    );

    public static final Item CHARTIUM_TORCH_ITEM = register(
        "chartium_torch",
    ...
    private static AttributeModifiersComponent bloodRutileArmorAttributes(ArmorItem.Type type, double hpIncrease) {
        RegistryEntry<ArmorMaterial> material = ArmorMaterials.BLOOD_RUTILE;
